...
var Game = new function() {                                                                  
  var KEY_CODES = { 37:'left', 38:'left', 39:'right', 40:'right', 32 :'fire' };
  this.keys = {};
...
//loading the game, setting the sprites on the canvas, setting the time.
...
//setting up the way sprites are moving on canvas.
...
//draws on the canvas    
  ...
  //when hitting the wall the alians move down by one row.
...
//when loading a new level JS pushes new player onto the scene.
...
//when loading a new level JS pushes new formation on aliens onto the scene.
